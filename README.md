...
<details>
  ...
  >**자격증은 꼭 따지 않아도 지식을 쌓는데 도움이 된다!**  
  >`답-암기 보다는 개념을 배운다 생각하고 응시하기!`   
  >`목표 == 삶의 원동력!`  
...
- **공부중인 & 따면좋을** : 전기기능사, 자동화설비기능사, PLC 제어기술자 3급/2급
- **추상적인** : AI-Vision 관련, Robot-Sequence Code관련(협동로봇이 일반화 가정),
- **미래의** : 산업안전기사, 설비보전기사, 전기기사
</details>
